...
public class FileUtils extends org.apache.commons.io.FileUtils {
     ...
     */  
    public static String readFileByChars1(String fileName) {  
        File file = new File(fileName);  
        Reader reader = null;  
        String string = "";
        try {  
     ...
     */  
    public static void appendFileMethod(String fileName, String content) {  
        try {  
	...
	public static void main(String[] args) {
		//writeToFile("D://1121.json","这是一个文件",true);
		readFileByChars1("D:\\order.txt");
	}
}
