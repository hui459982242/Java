...
public class XmlUtils {  
    public static void main(String[] args) throws DocumentException, IOException {  
        String textFromFile = FileUtils.readFileToString(new File("/Users/order.txt"),"UTF-8");  
        Map<String, Object> map = xml2mapWithAttr(textFromFile, false);  
        //System.out.println(((Map)map.get("ERROR")).get("#text"));
...
//		String soap = "/Users/zhaohui/order.txt";
...
//				"</Response>";*/
//		//获得字段s:SourceSysId的值;
//		System.out.println(getStringToDomp(soap));
//		//String id = map.get("waybillNo").toString();
